...
})({"jHMLp":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 59207;
...
const Translations = {
    en: {
        ...
        'Show Probability per Option:': 'Show Probability per Option:',
        ...
        'Skill Cooldown Time (seconds):': 'Skill Cooldown Time (seconds):',
        'Skill Probability (%):': 'Skill Probability (%):',
        'Probability per Option': 'Probability per Option',
    ...
    ko: {
        ...
        'Show Probability per Option:': "\uC635\uC158\uBCC4 \uD655\uB960 \uBCF4\uC5EC\uC8FC\uAE30:",
        'Minimap Zoom': "\uBBF8\uB2C8\uB9F5 \uC90C",
        'Game Settings': "\uAC8C\uC784 \uC124\uC815",
        'Map:': "\uB9F5:",
        'Auto Recording:': "\uC790\uB3D9 \uB179\uD654:",
        'Winner Selection:': "\uB2F9\uCCA8\uC790 \uC120\uD0DD:",
        'Skill Settings': "\uC2A4\uD0AC \uC124\uC815",
        'Enable Skills:': "\uC2A4\uD0AC \uD65C\uC131\uD654:",
        'Skill Cooldown Time (seconds):': "\uC2A4\uD0AC \uCFE8\uD0C0\uC784 (\uCD08):",
        'Skill Probability (%):': "\uC2A4\uD0AC \uD655\uB960 (%):",
        'Probability per Option': "\uC635\uC158\uBCC4 \uD655\uB960",
        'Game Result': "\uAC8C\uC784 \uACB0\uACFC"
    }
};
...
class Roulette extends EventTarget {
    ...
    setZoom(zoomLevel) {
        const relativeZoom = Math.max(0.1, Math.min(5, zoomLevel / (0, _constants.initialZoom)));
    ...
    setMinimapZoom(zoom) {
        const minimap = this._uiObjects.find((obj)=>obj.constructor.name === 'Minimap');
        if (minimap && minimap.setZoomFactor) minimap.setZoomFactor(zoom);
    }
    getMinimapZoom() {
        const minimap = this._uiObjects.find((obj)=>obj.constructor.name === 'Minimap');
...
const stages = [
    ...
    {
        title: 'Original Wheel of fortune',
        goalY: 111,
        zoomY: 106.75,
        entities: [
            // polyline
...
},{"./data/constants":"dKlb7","c5fa5cad7ab28dff":"fEghL","e27ebf0909884c3d":"lEaYi","829379cacf56b816":"9m1Wx","d7a95745752c0f1":"66J9F","d07804417049904b":"jkhjI","3c1155060c04461c":"4QZHP","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fEghL":[function(require,module,exports,__globalThis) {
...
},{"66ig1":"66ig1"}],"dWLxR":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["jHMLp","gH3Lb"], "gH3Lb", "parcelRequirefb90", {}, "./", "/")

//# sourceMappingURL=MarbleRoulette.34df32e0.js.map
