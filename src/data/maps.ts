...
export const stages: StageDef[] = [
  {
    ...
    entities: [
      ...
      //
      {
        position: { x: 13.5, y: 34 },
        type: 'static',
        shape: { type: 'box', width: 0.2, height: 0.2, rotation: -45 },
        props: { density: 1, angularVelocity: 0, restitution: 1.5 },
      },
      {
        position: { x: 13.5, y: 32 },
        type: 'static',
        shape: { type: 'box', width: 0.2, height: 0.2, rotation: -45 },
        props: { density: 1, angularVelocity: 0, restitution: 1.5 },
      },
      {
        position: { x: 13.5, y: 30 },
        type: 'static',
        shape: { type: 'box', width: 0.2, height: 0.2, rotation: -45 },
        props: { density: 1, angularVelocity: 0, restitution: 1.5 },
      },
      ...
      // Boundary boxes
      {
        position: { x: 9.79, y: 31.8 },
        type: 'static',
        shape: { type: 'box', width: 0.01, height: 1.76, rotation: 0 },
        props: { density: 1, angularVelocity: 0, restitution: 1.5 },
      },
      {
        position: { x: 17.4, y: 29.8 },
        type: 'static',
        shape: { type: 'box', width: 0.01, height: 3.7, rotation: 0 },
        props: { density: 1, angularVelocity: 0, restitution: 1.5 },
      },
      {
        position: { x: 13.5, y: 24.3 },
        type: 'static',
        shape: { type: 'box', width: 0.01, height: 4.3, rotation: -1.160643952576229 },
        props: { density: 1, angularVelocity: 0, restitution: 1.5 },
      },
      // Mid boxes
      {
      ...
      // Mid wheels
      {
        position: { x: 8, y: 75 },
        type: 'kinematic',
        shape: { type: 'box', width: 2.7, height: 0.1, rotation: 0 },
        props: { density: 1, angularVelocity: 3.5, restitution: 0 },
      },
      {
        position: { x: 13.3, y: 75 },
        type: 'kinematic',
        shape: { type: 'box', width: 2.7, height: 0.1, rotation: 0 },
        props: { density: 1, angularVelocity: -3.5, restitution: 0 },
      },
      {
        position: { x: 18.6, y: 75 },
        type: 'kinematic',
        shape: { type: 'box', width: 2.7, height: 0.1, rotation: 0 },
        props: { density: 1, angularVelocity: 3.5, restitution: 0 },
      },
      ...
      {
        position: { x: 10.8, y: 102 },
        type: 'static',
        shape: { type: 'box', width: 0.01, height: 3.7, rotation: -0.7278022980816354 },
        props: { density: 1, angularVelocity: 0, restitution: 1.2 },
      },
      {
        position: { x: 21.2, y: 102.6 },
        type: 'static',
        shape: { type: 'box', width: 0.01, height: 3.5, rotation: 0.9023352232810684 },
        props: { density: 1, angularVelocity: 0, restitution: 1.2 },
      },
      // Bounce boxes
      {
        position: { x: 15.5, y: 105.7 },
        type: 'static',
        shape: { type: 'box', width: 0.2, height: 0.2, rotation: 0.7853981633974483 },
        props: { density: 1, angularVelocity: 0, restitution: 2 },
      },
      {
        position: { x: 20.3, y: 102.4 },
        type: 'static',
        shape: { type: 'box', width: 0.2, height: 0.2, rotation: 0.7853981633974483 },
        props: { density: 1, angularVelocity: 0, restitution: 1.5 },
      },
      {
        position: { x: 11.8, y: 101.4 },
        type: 'static',
        shape: { type: 'box', width: 0.2, height: 0.2, rotation: 0.7853981633974483 },
        props: { density: 1, angularVelocity: 0, restitution: 1.5 },
      },
